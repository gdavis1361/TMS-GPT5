...
/**
 * Extends the Zend Pdf base class Zend_Pdf
 * Posted in the comments on http://framework.zend.com/manual/1.11/en/zend.pdf.pages.html
 */
class LP_Pdf extends Zend_Pdf{
